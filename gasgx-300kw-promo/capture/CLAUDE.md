...
Source: https://www.gasgx.com/products/300kw/
...
| `extracted/tokens.json` | Design tokens: 17 colors, 5 fonts, 1 headings, 3 CTAs |
...
- **Colors**: #9CA3AF (neutral), #F8F8F8 (bg-light), #E5E7EB (bg-light), #FFFFFF (bg-light), #000000 (bg-dark), #5DD62C (accent), #94A3B8 (neutral), #D1D5DB (surface-light), #0F0F0F (surface-dark), #101010 (surface-dark)
- **Fonts**: Font Awesome 6 Brands (400), Font Awesome 6 Free (400,900), Font Awesome 5 Brands (400), Font Awesome 5 Free (400,900), Inter (300,400,500,600,700,800,900)
