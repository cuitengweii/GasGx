                ...
                <div id="auth-user-profile" class="hidden items-center gap-2 group relative h-full">
                    ...
                    <div class="absolute right-0 top-full pt-1 w-48 hidden group-hover:block z-[60]">
                        <div class="bg-[#151515] border border-white/10 rounded-xl shadow-2xl py-2 mt-1">
                            ...
                            <a id="dropdown-sales-link" href="/account/account.html" class="hidden block w-full px-4 py-2 text-xs text-gray-300 hover:text-gas-green hover:bg-white/5 transition-colors border-b border-white/5 mb-1">
    ...
    <div class="mb-6 border-b border-white/10 pb-4 flex justify-center">
         ...
         <div id="mob-auth-user-profile" class="hidden flex flex-col gap-3 w-full max-w-xs px-2">
            ...
            <div class="flex items-center gap-2">
                <a id="mob-auth-sales-link" href="/account/account.html" class="hidden w-full text-xs text-gray-200 hover:text-gas-green border border-white/20 bg-white/5 px-3 py-1.5 rounded">
