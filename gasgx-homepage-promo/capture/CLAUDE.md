# GasGx - Unstrand the Gas. ReinventEnergy.Monetize On-site.

Source: https://www.gasgx.com/
...
| `extracted/tokens.json` | Design tokens: 13 colors, 6 fonts, 1 headings, 3 CTAs |
...
- **Colors**: #9CA3AF (neutral), #E5E7EB (bg-light), #000000 (bg-dark), #FFFFFF (bg-light), #5DD62C (accent), #F8F8F8 (bg-light), #0F0F0F (surface-dark), #94A3B8 (neutral), #D1D5DB (surface-light), #151515 (surface-dark)
- **Fonts**: Font Awesome 6 Brands (400), Font Awesome 6 Free (400,900), Font Awesome 5 Brands (400), Font Awesome 5 Free (400,900), Inter (300,400,500,600,700,900), JetBrains Mono (400,700)
