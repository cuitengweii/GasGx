        ...
        <header class="fixed top-0 w-full z-50 gsh-header-glass h-16">
            <div class="max-w-[1600px] mx-auto px-4 lg:px-6 h-full flex justify-between items-center">
                ...
                <div class="flex items-center gap-3 md:gap-4">
                    ...
                    <a href="/news/account.html" id="${idPrefix}-header-account-trigger" class="lg:hidden flex items-center gap-2 text-[10px] font-bold text-gas-green border border-gas-green/30 bg-gas-green/10 px-3 py-1.5 rounded-full hover:bg-gas-green hover:text-black transition-all max-w-[140px]" aria-label="Account">
...
export function renderSharedAuthState(options = {}) {
    ...
    const accountUrl = options.accountUrl || '/news/account.html';
