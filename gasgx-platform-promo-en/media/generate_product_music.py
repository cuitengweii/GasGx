...
for bar_index in range(13):
    ...
    # Broad, restrained chord beds keep the track premium while the low-end pulse
    # and metallic accents give the product reveal an industrial energy.
...
gain = 0.84 / peak
output_path = Path(__file__).with_name("product-music-energy-showcase.wav")
